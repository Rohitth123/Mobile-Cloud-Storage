...
<div class="main">
  <div class="header">
	...
	<div class="logo style1">
        <h3 class="style1 style2">Enabling Efficient Secure and Privacy preserving<br /> 
        Mobile Cloud Storage </h3>
      </div>
      <div class="menu_nav">
        <ul>
  ...
  <tr>
		<td height="29">
		<div align="center" class="style4"><%=s1%></div>		</td>
		<td>
	...
	<div align="center" class="style4"><a href="Process.jsp?uname=<%=s1%>&fname=<%=s2%>"><%=s5%></a></div>		</td>
	<%	}%>
	</tr>
